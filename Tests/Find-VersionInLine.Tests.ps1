Describe "Find-VersionInLine" {
    ...
    Context "AssemblyVersion 4 numbers" {
        It "Returns 1.2.3.4" {
            $Start, $Version, $End = Find-VersionInLine -Line "[assembly: AssemblyVersion(""1.2.3.4"")]"
    ...
    Context "AssemblyVersion 3 numbers" {
        It "Returns 1.2.3" {
            $Start, $Version, $End = Find-VersionInLine -Line "[assembly: AssemblyVersion(""1.2.3"")]"
            $Start | Should Be "[assembly: AssemblyVersion("""
            $Version.Major | Should Be 1
            $Version.Minor | Should Be 2
            $Version.Build | Should Be 3
    ...
    Context "AssemblyVersion 2 numbers" {
        It "Returns 1.2" {
            $Start, $Version, $End = Find-VersionInLine -Line "[assembly: AssemblyVersion(""1.2"")]"
            $Start | Should Be "[assembly: AssemblyVersion("""
            $Version.Major | Should Be 1
            $Version.Minor | Should Be 2
    ...
    Context "AssemblyVersion 1 number" {
        It "Returns null" {
            $Start, $Version, $End = Find-VersionInLine -Line "[assembly: AssemblyVersion(""1"")]"
    ...
    Context "AssemblyVersion Minor Zero " {
        It "Returns 1.0.3" {
            $Start, $Version, $End = Find-VersionInLine -Line "[assembly: AssemblyVersion(""1.0.3"")]"
            $Start | Should Be "[assembly: AssemblyVersion("""
            $Version.Major | Should Be 1
    ...
    Context "AssemblyVersion Major Zero" {
        It "Returns 0.2.3" {
            $Start, $Version, $End = Find-VersionInLine -Line "[assembly: AssemblyVersion(""0.2.3"")]"
            $Start | Should Be "[assembly: AssemblyVersion("""
    ...
    Context "AssemblyVersion Major and Minor Zero" {
        It "Returns 0.0.3" {
            $Start, $Version, $End = Find-VersionInLine -Line "[assembly: AssemblyVersion(""0.0.3"")]"
            $Start | Should Be "[assembly: AssemblyVersion("""
            $Version.Major | Should Be 0
            $Version.Minor | Should Be 0
            $Version.Build | Should Be 3
    ...
    Context "AssemblyVersion Zero" {
        It "Returns 0.0.0" {
            $Start, $Version, $End = Find-VersionInLine -Line "[assembly: AssemblyVersion(""0.0.0"")]"
            $Start | Should Be "[assembly: AssemblyVersion("""
            $Version.Major | Should Be 0
            $Version.Minor | Should Be 0
    ...
    Context "xml 3 numbers" {
        It "Returns 1.2.3" {
            $Start, $Version, $End = Find-VersionInLine -Line "<FileVersion>1.2.3</FileVersion>"
    ...
    Context "xml 3 numbers v" {
        It "Returns 1.2.3" {
            $Start, $Version, $End = Find-VersionInLine -Line "<Version>v1.2.3</Version>"
    ...
    Context "xml 4 numbers and zeroes" {
        It "Returns 0.0.3.0" {
            $Start, $Version, $End = Find-VersionInLine -Line "<FileVersion>0.0.3.0</FileVersion>"
            $Start | Should Be "<FileVersion>"
            $Version.Major | Should Be 0
            $Version.Minor | Should Be 0
            $Version.Build | Should Be 3
    ...
    Context "Multi digit numbers and zeroes" {
        It "Returns 0.0.13.5678" {
            $Start, $Version, $End = Find-VersionInLine -Line "<FileVersion>0.0.13.5678</FileVersion>"
            $Start | Should Be "<FileVersion>"
            $Version.Major | Should Be 0
            $Version.Minor | Should Be 0
    ...
    Context "Zero-padded" {
        It "Returns 0.01.03.100" {
            $Start, $Version, $End = Find-VersionInLine -Line "<FileVersion>0.01.03.100</FileVersion>"
            $Start | Should Be "<FileVersion>"
            $Version.Major | Should Be 0
    ...
    Context "TargetFramework" {
        It "Returns net6.0" {
            $Start, $Version, $End = Find-VersionInLine -Line "<TargetFramework>net6.0</TargetFramework>"
